        ...
        {siteConfig.navigation.map((item) => {
          ...
          return (
            <Link
              ...
              className={`relative-link relative rounded-md px-2.5 py-2 font-medium text-[12px] transition-all duration-200 md:text-[13px] ${active ? 'text-black dark:text-white' : 'text-muted-subtle hover:text-stone-700 dark:hover:text-stone-200'}`}
            >
